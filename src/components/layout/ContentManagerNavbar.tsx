...
interface ContentManagerNavbarProps {
  collapsed?: boolean;
}

const ContentManagerNavbar: React.FC<ContentManagerNavbarProps> = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const user = localStorage.getItem('username') || 'Content Manager';
  const handleLogout = () => {
    logout();
            ...
            >
              <div className="d-flex align-items-center">
                ...
                <div className="d-none d-md-block">
                  ...
                  <small className="text-muted">Quản lý nội dung</small>
                </div>
              </div>
            </Dropdown.Toggle>
            <Dropdown.Menu>
              <Dropdown.Item onClick={() => navigate("/content-manager/profile")}>
                Profile
              </Dropdown.Item>
              <Dropdown.Divider />
...
export default withAuthCheck(ContentManagerNavbar);